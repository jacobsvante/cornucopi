...
pub mod queries {
    pub mod bench {
        #[derive(Debug)]
        pub struct InsertUserParams<T1: cornucopi_async::StringSql, T2: cornucopi_async::StringSql> {
            pub name: T1,
        ...
        pub mod sync {
            ...
            pub fn users() -> UsersStmt {
                UsersStmt(cornucopi_sync::private::Stmt::new("SELECT * FROM users"))
            }
            pub struct UsersStmt(cornucopi_sync::private::Stmt);
            impl UsersStmt {
            ...
            pub fn insert_user() -> InsertUserStmt {
                InsertUserStmt(cornucopi_sync::private::Stmt::new(
                    "INSERT INTO users (name, hair_color) VALUES ($1, $2)",
                ))
            }
            pub struct InsertUserStmt(cornucopi_sync::private::Stmt);
            impl InsertUserStmt {
                pub fn bind<
                    'a,
                    C: GenericClient,
            ...
            pub fn posts() -> PostsStmt {
                PostsStmt(cornucopi_sync::private::Stmt::new("SELECT * FROM posts"))
            }
            pub struct PostsStmt(cornucopi_sync::private::Stmt);
            impl PostsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a mut C,
            ...
            pub fn post_by_user_ids() -> PostByUserIdsStmt {
                PostByUserIdsStmt(cornucopi_sync::private::Stmt::new(
                    "SELECT * FROM posts WHERE user_id = ANY($1)",
                ))
            }
            pub struct PostByUserIdsStmt(cornucopi_sync::private::Stmt);
            impl PostByUserIdsStmt {
                pub fn bind<'a, C: GenericClient, T1: cornucopi_sync::ArraySql<Item = i32>>(
                    &'a mut self,
                    client: &'a mut C,
                    ids: &'a T1,
            ...
            pub fn comments() -> CommentsStmt {
                CommentsStmt(cornucopi_sync::private::Stmt::new("SELECT * FROM comments"))
            }
            pub struct CommentsStmt(cornucopi_sync::private::Stmt);
            impl CommentsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a mut C,
            ...
            pub fn comments_by_post_id() -> CommentsByPostIdStmt {
                CommentsByPostIdStmt(cornucopi_sync::private::Stmt::new(
                    "SELECT * FROM comments WHERE post_id = ANY($1)",
                ))
            }
            pub struct CommentsByPostIdStmt(cornucopi_sync::private::Stmt);
            ...
            pub fn select_complex() -> SelectComplexStmt {
                SelectComplexStmt(cornucopi_sync::private::Stmt::new("SELECT u.id as myuser_id, u.name, u.hair_color, p.id as post_id, p.user_id, p.title, p.body FROM users as u LEFT JOIN posts as p on u.id = p.user_id"))
            }
            pub struct SelectComplexStmt(cornucopi_sync::private::Stmt);
        ...
        pub mod async_ {
            ...
            pub fn users() -> UsersStmt {
                UsersStmt(cornucopi_async::private::Stmt::new("SELECT * FROM users"))
            }
            pub struct UsersStmt(cornucopi_async::private::Stmt);
            impl UsersStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn posts() -> PostsStmt {
                PostsStmt(cornucopi_async::private::Stmt::new("SELECT * FROM posts"))
            }
            pub struct PostsStmt(cornucopi_async::private::Stmt);
            impl PostsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn post_by_user_ids() -> PostByUserIdsStmt {
                PostByUserIdsStmt(cornucopi_async::private::Stmt::new(
                    "SELECT * FROM posts WHERE user_id = ANY($1)",
                ))
            }
            pub struct PostByUserIdsStmt(cornucopi_async::private::Stmt);
            impl PostByUserIdsStmt {
            ...
            pub fn comments() -> CommentsStmt {
                CommentsStmt(cornucopi_async::private::Stmt::new(
                    "SELECT * FROM comments",
                ))
            }
            pub struct CommentsStmt(cornucopi_async::private::Stmt);
            impl CommentsStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn comments_by_post_id() -> CommentsByPostIdStmt {
                CommentsByPostIdStmt(cornucopi_async::private::Stmt::new(
                    "SELECT * FROM comments WHERE post_id = ANY($1)",
                ))
            }
            pub struct CommentsByPostIdStmt(cornucopi_async::private::Stmt);
            impl CommentsByPostIdStmt {
                pub fn bind<'a, C: GenericClient, T1: cornucopi_async::ArraySql<Item = i32>>(
                    &'a mut self,
                    client: &'a C,
            ...
            pub fn select_complex() -> SelectComplexStmt {
                SelectComplexStmt(cornucopi_async::private::Stmt::new("SELECT u.id as myuser_id, u.name, u.hair_color, p.id as post_id, p.user_id, p.title, p.body FROM users as u LEFT JOIN posts as p on u.id = p.user_id"))
            }
            pub struct SelectComplexStmt(cornucopi_async::private::Stmt);
            impl SelectComplexStmt {
                pub fn bind<'a, C: GenericClient>(
                    &'a mut self,
                    client: &'a C,
